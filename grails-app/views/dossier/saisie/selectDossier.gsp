            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name">Date Cloture:</td>
                            
                            <td valign="top" class="value">${dossier.dateCloture}</td>
                            
                        </tr>
                    
                        <tr class="prop">
                            <td valign="top" class="name">Compte Attachement:</td>
                            
                            <td valign="top" class="value"><g:link controller="compte" action="show" id="${dossier?.compteAttachement?.id}">${dossier?.compteAttachement}</g:link></td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name">Comptes Attaches:</td>
                            
                            <td valign="top" class="value">${dossier.comptesAttaches}</td>
