...
<html>
    <head>
        ...
        <title>Import de dossiers</title> 
		<style type="text/css">
					...
					<tbody>
						<tr class="prop">
							...
							<td valign="top" class="value">
										...
										<g:link class="xls" controller="dossier" action="xlsTemplate">Mod&egrave;le</g:link>
							
							</td>
						</tr> 					
						<tr class="prop">
							<td valign="top" class="name">
								<span class="num">2</span><label for="operation"><etude:traduction name="operation" default="Saisir les dossiers dans ce mod&egrave;le" /></label>
							</td>
