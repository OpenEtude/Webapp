...
<html>
    <head>
        ...
        <title>Uniformiser les libell&eacute;s des comptes</title>
    </head>
    <body>
        ...
        <div class="body">
            <h1>Uniformiser les libell&eacute;s des comptes</h1>
            <g:if test="${flash.message}">
            <div class="${flash.messageType?flash.messageType:'message'}">${flash.message}</div>
            </g:if>
			<div class="dialog">
			<g:form accept-charset="UTF-8" controller="compte" action="uniformiser" method="post" >
