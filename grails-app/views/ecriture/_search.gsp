                ...
                <div class="dialog">
                    <table>
                        <tbody>
				            ...
				            <tr class='prop'><td valign='top' class='name'><label for='commentaire'>Commentaire:</label></td><td valign='top' class='value'><input type="text" id='commentaire' name='commentaire'/></td></tr>
