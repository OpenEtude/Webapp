<html>
    <head>
        ...
        <title>Relev&eacute; de Compte Bancaire : ${compteBancaire?.libelle} (${etat.libelle})</title>
    </head>
    <body>
    ...
    %>        <div class="body">
            <h1>${compteBancaire?.libelle} (${etat.libelle})</h1>
	...
	<g:pieChart title="Repartition par \u00e9criture" colors="${colors}" size="${[600,300]}"
      labels="${labels}" fill="${'bg,s,f0f0f0|c,s,f0f0f0'}" dataType='text' data='${values}'/>
            <div class="database_table" style="margin:30px">
                <table>
                    <thead>
                        <tr>
							<th>Libell&eacute;</th>
