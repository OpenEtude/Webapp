...
<html>
    <head>
        ...
        <title>Modifier JsecRolePermissionRel</title>
    </head>
    <body>
        <div class="nav">
        ...
        <div class="body">
            <h1>Modifier JsecRolePermissionRel</h1>
            ...
            <g:form accept-charset="UTF-8"   controller="jsecRolePermissionRel" method="post" >
